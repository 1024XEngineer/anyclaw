...
var onboardCmd = &cobra.Command{
	Use:   "onboard",
	Short: "Interactive setup wizard for anyclaw",
	Long: `Guided setup wizard for anyclaw.
...
func runOnboard(cmd *cobra.Command, args []string) {
	fmt.Println()
	fmt.Println("╔════════════════════════════════════════════════════════╗")
	fmt.Println("║                    AnyClaw Onboarding                      ║")
	fmt.Println("╚════════════════════════════════════════════════════════╝")
	fmt.Println()

	// 1. Initialize config file and built-in skills
	fmt.Println("Step 1: Initializing anyclaw environment...")
	anyclawDir := internal.GetAnyclawDir()
...
func printSummary(cfg *config.Config) {
	...
	fmt.Println("═════════════════════════════════════════════════════════")
	fmt.Println()
	fmt.Println("  1. Start anyclaw:")
	fmt.Println("     $ anyclaw start")
	fmt.Println()
	...
	fmt.Println("     $ anyclaw skills list")
	fmt.Println()
	fmt.Println("For more information, see README.md and docs/.")
	fmt.Println()
}
