...
var LogsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View anyclaw logs",
	Long:  `View and follow anyclaw application logs with color formatting and filtering.`,
	Run:   runLogs,
}
...
func detectLogPath() string {
	...
	candidates := []string{
		filepath.Join(home, ".anyclaw", "logs", "anyclaw.log"),
		filepath.Join(home, ".anyclaw", "anyclaw.log"),
		"anyclaw.log",
		"logs/anyclaw.log",
	}
	...
	if home != "" {
		...
		if _, err := os.Stat("/var/log"); err == nil {
			candidates = append(candidates, filepath.Join("/var", "log", "anyclaw.log"))
		}
	}
	...
	return filepath.Join(home, ".anyclaw", "logs", "anyclaw.log")
}
