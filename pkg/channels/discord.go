...
func NewDiscordAdapter(cfg config.DiscordChannelConfig, router *Router, appendEvent func(eventType string, sessionID string, payload map[string]any)) *DiscordAdapter {
