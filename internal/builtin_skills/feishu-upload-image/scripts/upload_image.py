...
def load_config() -> tuple[str, str]:
    """Load Feishu credentials from anyclaw config file (~/.anyclaw/config.json)"""
    # Try to load from anyclaw config file ~/.anyclaw/config.json
    config_path = Path.home() / ".anyclaw" / "config.json"
    ...
    if not app_id or not app_secret:
        ...
        print("Configure in ~/.anyclaw/config.json under channels.feishu:")
        print('  {')
        print('    "channels": {')
        print('      "feishu": {')
